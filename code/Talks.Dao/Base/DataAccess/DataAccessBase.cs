...
namespace Talks.Dao.Base.DataAccess
{
    ...
    public class DataAccessBase
    {
        ...
        #region ExecuteNonQuery Read

        protected int ExecuteNonQueryRead(string commandText)
        {
            return ExecuteNonQueryRead(commandText, (SqlParameter[])null);
        }

        protected int ExecuteNonQueryRead(string commandText, SqlParameter[] commandParameters)
        {
        ...
        #endregion ExecuteNonQuery Read

        #region ExecuteDataset Read
        protected DataSet ExecuteDatasetRead(string commandText)
        {
            return ExecuteDatasetRead(commandText, (SqlParameter[])null);
        }


        protected DataSet ExecuteDatasetRead(string commandText, SqlParameter[] commandParameters)
        {
            using (SqlConnection connection = ConnFactory.CreateConnection())
            {
                connection.Open();
        ...
        #endregion ExecuteDataset Read

        #region ExecuteScalar Read

        protected object ExecuteScalarRead(string commandText)
        {
            return ExecuteScalarRead(commandText, (SqlParameter[])null);
        }


        protected object ExecuteScalarRead(string commandText, SqlParameter[] commandParameters)
        {
            using (SqlConnection connection = ConnFactory.CreateConnection())
            {
                connection.Open();
